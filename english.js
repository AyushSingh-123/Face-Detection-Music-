...
function display(){
  ...
  if(startdetection.neutral>=0.987675435566){
    ...
    window.open("https://music.youtube.com/playlist?list=PLP2qAKm-AAm9hIxpLbaMOcG2428lrssd5")
}
else if(startdetection.happy>=0.97776736637467){
 window.open("https://music.youtube.com/playlist?list=RDCLAK5uy_mfdqvCAl8wodlx2P2_Ai2gNkiRDAufkkI ")
 }
 else if(startdetection.angry>=0.97776736656467){
    window.open("https://music.youtube.com/playlist?list=PLPUNbCqAw29JGyM0Yy4DPZnZjdmMPwp2R ")
} 

 else if(startdetection.sad>=0.97776736658736847){
    window.open(" https://music.youtube.com/playlist?list=PLgzTt0k8mXzHcKebL8d0uYHfawiARhQja")
} 
    function pause1(){
