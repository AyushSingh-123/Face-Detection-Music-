...
function display(){
  ...
  if(startdetection.neutral>=0.987675435566){
    ...
    window.open("https://music.youtube.com/playlist?list=PLleyY1Z_tn8eJ1Ruw1jLfxnyySJdcrUzj")
}
else if(startdetection.happy>=0.97776736637467){
 window.open(" https://music.youtube.com/watch?v=mNFEykH_hoE")
 }
    ...
    window.open(" https://music.youtube.com/watch?v=iYcC0VdmT0c")
} 
    function pause1(){
